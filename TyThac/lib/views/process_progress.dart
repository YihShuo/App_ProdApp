...
class ProcessProgress extends StatefulWidget {
  const ProcessProgress({super.key});

  @override
  ProcessProgressState createState() => ProcessProgressState();
}

class ProcessProgressState extends State<ProcessProgress> {
  ...
  void getOrders() async {
    orderList = [];
    try {
      final body = await RemoteService().getProcessingDispatchedOrder(
        apiAddress,
        '${sFactory}_$sLean',
        filterRYController.text
      );
      ...
      Fluttertoast.showToast(
        msg: AppLocalizations.of(context)!.processProgressLoadingError,
    ...
    if (jsonData.length > 0) {
      for (int i = 0; i < jsonData.length; i++) {
        orders.add(Padding(
          ...
          child: InkWell(
            onTap: () {
              Navigator.pushNamed(context, '/process_progress/chart', arguments: jsonData[i]["Order"]);
            },
            child: Ink(
              width: screenWidth,
              ...
              child: Column(
                children: [
                      ...
                      children: [
                        ...
                        Expanded(
                          child: Align(
                            ...
                            child: Text(AppLocalizations.of(context)!.processProgressInProduction, style: const TextStyle(fontSize: 18, color: Color.fromRGBO(255, 153, 0, 1)))
                          )
                        )
                      ],
                    ),
                  ...
                  Padding(
                    ...
                    child: Row(
                      children: [
                        Text('${AppLocalizations.of(context)!.processProgressAssemblyDate}${jsonData[i]["AssemblyDate"]}', style: const TextStyle(fontSize: 14)),
                      ],
                    ),
                  ),
                  Padding(
                    ...
                    child: Row(
                      children: [
                        Text('${AppLocalizations.of(context)!.processProgressShipDate}${jsonData[i]["ShipDate"]}', style: const TextStyle(fontSize: 14)),
                      ],
                    ),
                  ),
                  Padding(
                    ...
                    child: Row(
                      children: [
                        Text('${AppLocalizations.of(context)!.processProgressSKU}${jsonData[i]["SKU"]}', style: const TextStyle(fontSize: 14)),
                      ],
                    ),
                  ),
                  Padding(
                      ...
                      children: [
                        SizedBox(
                          ...
                          child: Column(
                            ...
                            children: [
                              Text(AppLocalizations.of(context)!.processProgressBuyNo, style: const TextStyle(fontSize: 14, color: Colors.grey)),
      ...
      orders.add(SizedBox(
        ...
        child: Align(
            ...
            child: Text(AppLocalizations.of(context)!.processProgressNoDispatchedOrder, style: const TextStyle(fontSize: 18))
        ),
      ));
    }
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text(AppLocalizations.of(context)!.processProgressTitle),
        actions: [
          IconButton(
            icon: const Icon(
              Icons.filter_alt,
      ...
      content: Column(
        children: [
          Align(
            ...
            child: Text(AppLocalizations.of(context)!.processProgressFilterFactory)
          ),
          ...
          Align(
              alignment: Alignment.centerLeft,
              child: Text(AppLocalizations.of(context)!.processProgressFilterLean)
          ),
          DropdownButton<String>(
            isExpanded: true,
            underline: Container(
