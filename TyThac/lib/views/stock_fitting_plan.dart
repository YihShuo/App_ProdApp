...
class StockFittingPlan extends StatefulWidget {
  const StockFittingPlan({super.key});

  @override
  StockFittingPlanState createState() => StockFittingPlanState();
}

class StockFittingPlanState extends State<StockFittingPlan> {
  String userName = '';
  String group = '';
  ...
  Future<void> loadPlan() async {
    ...
    final body = await RemoteService().getStockFittingPlan(
      apiAddress,
              ...
              child: Container(
                ...
                child: ListTile(
                  ...
                  subtitle: Column(
                    ...
                    children: [
                      Text(jsonData[i]['Plan'][j]['SKU'] + ' - ' + jsonData[i]['Plan'][j]['Type'] + ' [' + jsonData[i]['Plan'][j]['Outsole'] + ']', style: const TextStyle(fontSize: 10)),
                  ...
                  trailing: Column(
                    mainAxisAlignment: MainAxisAlignment.center,
                    children: [
                      Text(jsonData[i]['Plan'][j]['Pairs'].toString(), style: const TextStyle(fontSize: 14)),
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            Text(AppLocalizations.of(context)!.sideMenuStockFittingPlan),
