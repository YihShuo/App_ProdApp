...
class StitchingWorkOrderDispatch extends StatefulWidget {
  const StitchingWorkOrderDispatch({super.key});

  @override
  StitchingWorkOrderDispatchState createState() => StitchingWorkOrderDispatchState();
}

class StitchingWorkOrderDispatchState extends State<StitchingWorkOrderDispatch> {
    ...
    return Scaffold(
      appBar: AppBar(
        leading: IconButton(
          ...
          onPressed: () {
            Navigator.of(context).popUntil((route) => route.settings.name == '/stitching');
          },
        ),
        title: Text(order),
            ...
            Container(
              ...
              child: Padding(
                ...
                child: OutlinedButton(
                      ...
                      builder: (BuildContext context) {
                        if (selection.isNotEmpty) {
                          return MessageDialog(
                            ...
                            contentText: AppLocalizations.of(context)!.stitchingWorkOrderDispatchDispatchingConfirmContent,
                            showOKButton: true,
                          ...
                          return MessageDialog(
                            key: globalKey,
                            titleText: AppLocalizations.of(context)!.stitchingWorkOrderDispatchNotSelectTitle,
                            contentText: AppLocalizations.of(context)!.stitchingWorkOrderDispatchDispatchingNotSelectContent,
                            showOKButton: true,
                            showCancelButton: false,
                            onPressed: () {
                              Navigator.of(context).popUntil((route) => route.settings.name == '/stitching/dispatch');
                            },
                          );
                        }
                      }
                  ...
                  child: Center(
                    child: Text(AppLocalizations.of(context)!.stitchingWorkOrderDispatchDispatching, style: const TextStyle(color: Colors.black, fontWeight: FontWeight.bold, fontSize: 20)),
                  )
                )
              ),
            )
