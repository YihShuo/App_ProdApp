...
class R2Plan extends StatefulWidget {
  const R2Plan({super.key});

  @override
  R2PlanState createState() => R2PlanState();
}

class R2PlanState extends State<R2Plan> {
  String userName = '';
  String group = '';
  ...
  Future<void> loadPlan() async {
    ...
    final body = await RemoteService().getR2Plan(
      apiAddress,
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            Text(AppLocalizations.of(context)!.sideMenuR2Plan),
