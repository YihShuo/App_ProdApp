...
class AssemblyWorkOrder extends StatefulWidget {
  const AssemblyWorkOrder({super.key});

  @override
  AssemblyWorkOrderState createState() => AssemblyWorkOrderState();
}

class AssemblyWorkOrderState extends State<AssemblyWorkOrder> {
  ...
  void getOrders() async {
    orderList = [];
    try {
      final body = await RemoteService().getMonthAssemblyOrder(
        apiAddress,
        '${sFactory}_$sLean',
        selectedMonth,
        sType,
    ...
    if (jsonData.length > 0) {
      for (int i = 0; i < jsonData.length; i++) {
        orders.add(Padding(
          ...
          child: InkWell(
            onTap: () {
              Navigator.pushNamed(context, '/assembly/dispatch', arguments: jsonData[i]["Order"] + ';${sFactory}_$sLean');
            },
            child: Ink(
              width: screenWidth,
              ...
              child: Column(
                children: [
                      ...
                      children: [
                        ...
                        Expanded(
                          child: Align(
                            ...
                            ? Text(AppLocalizations.of(context)!.assemblyWorkOrderNoCuttingData, style: const TextStyle(fontSize: 18, color: Color.fromRGBO(204, 51, 0, 1)))
                            : jsonData[i]["Status"] == 'NotDispatch'
                            ? Text(AppLocalizations.of(context)!.assemblyWorkOrderNotDispatch, style: const TextStyle(fontSize: 18, color: Color.fromRGBO(204, 51, 0, 1)))
                            : jsonData[i]["Status"] == 'InProduction'
                            ? Text(AppLocalizations.of(context)!.assemblyWorkOrderInProduction, style: const TextStyle(fontSize: 18, color: Color.fromRGBO(255, 153, 0, 1)))
                            : Text(AppLocalizations.of(context)!.assemblyWorkOrderCompleted, style: const TextStyle(fontSize: 18, color: Color.fromRGBO(0, 153, 0, 1)))
                          )
                        )
                      ],
                    ),
                  ...
                  Padding(
                    ...
                    child: Row(
                      children: [
                        Text('${AppLocalizations.of(context)!.assemblyWorkOrderAssemblyDate}${jsonData[i]["AssemblyDate"]}', style: const TextStyle(fontSize: 14)),
                      ],
                    ),
                  ),
                  Padding(
                    ...
                    child: Row(
                      children: [
                        Text('${AppLocalizations.of(context)!.assemblyWorkOrderShipDate}${jsonData[i]["ShipDate"]}', style: const TextStyle(fontSize: 14)),
                      ],
                    ),
                  ),
                  Padding(
                    ...
                    child: Row(
                      children: [
                        Text('${AppLocalizations.of(context)!.assemblyWorkOrderSKU}${jsonData[i]["SKU"]}', style: const TextStyle(fontSize: 14)),
                      ],
                    ),
                  ),
                  Padding(
                      ...
                      children: [
                        SizedBox(
                          ...
                          child: Column(
                            ...
                            children: [
                              Text(AppLocalizations.of(context)!.assemblyWorkOrderBuyNo, style: const TextStyle(fontSize: 14, color: Colors.grey)),
      ...
      orders.add(SizedBox(
        ...
        child: Align(
          ...
          child: Text(AppLocalizations.of(context)!.assemblyWorkOrderNoScheduleOrder, style: const TextStyle(fontSize: 18))
        ),
      ));
    }
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text(AppLocalizations.of(context)!.assemblyWorkOrderTitle),
    ...
    return AlertDialog(
      ...
      content: Column(
        children: [
          ...
          DropdownButton<String>(
            ...
            items: [
              DropdownMenuItem(
                value: 'Incomplete',
                child: Center(
                  child: Text(AppLocalizations.of(context)!.dispatchedByPM),
                )
              ),
              DropdownMenuItem(
                value: 'All',
                child: Center(
                  child: Text(AppLocalizations.of(context)!.assemblyWorkOrderFilterAll),
                )
              )
            ],
            onChanged: (value) {
          ...
          Align(
            alignment: Alignment.centerLeft,
            child: Text(AppLocalizations.of(context)!.assemblyWorkOrderFilterDate)
          ),
          SizedBox(
            height: 40,
            child: TextField(
          ...
          Align(
            alignment: Alignment.centerLeft,
            child: Text(AppLocalizations.of(context)!.assemblyWorkOrderFilterFactory)
          ),
          DropdownButton<String>(
            isExpanded: true,
            underline: Container(
          ...
          Align(
            alignment: Alignment.centerLeft,
            child: Text(AppLocalizations.of(context)!.assemblyWorkOrderFilterLean)
          ),
          DropdownButton<String>(
            isExpanded: true,
            underline: Container(
