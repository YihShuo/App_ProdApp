...
class ProcessChart extends StatefulWidget {
  const ProcessChart({super.key});

  @override
  State<StatefulWidget> createState() => ProcessChartState();
}

class ProcessChartState extends State<ProcessChart> {
  String order = '';
  String lean = '';
  String userName = '';
  String group = '';
                        ...
                        return Visibility(
                          ...
                          child: Card(
                            ...
                            child: InkWell(
                              ...
                              ? () {
                                  Navigator.pushNamed(context, '/process/chart/dispatch', arguments: '$order;$section;$sectionName;$lean');
                                }
                              : null,
                              child: Column(
                                children: [
